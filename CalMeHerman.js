...
petik = '```'
fake = '©ItsMeTama'//GANTI NAMA KAMU BEP
ban =[]
...
module.exports = dha = async (dha, mek) => {
	try {
        ...
        const listmsg = (from, title, desc, list) => { // ngeread nya pake rowsId, jadi command nya ga keliatan
            let po = dha.prepareMessageFromContent(from, {"listMessage": {"title": title,"description": desc,"buttonText": "𝕾𝖎𝖑𝖆𝖍𝖐𝖆𝖓 𝕻𝖎𝖑𝖎𝖍 𝕯𝖎𝖘𝖓𝖎!","footerText": "Call Me Tama","listType": "SINGLE_SELECT","sections": list}}, {})
...
༒ *INFO BOT* ༒
ᱝ *Nama : *ItsMeTama*
ᱝ *Nomor :* @6287871956719 [PEMBUAT BOT]
ᱝ *Owner : *TamaXD* 
...
*Sewa bot?* Chat wa.me/6287871956719`
...
*Chat Owner :* wa.me/6287871956719`
              dha.sendMessage(from, await getBuffer(gopeynya), image, {quoted: ftoko, caption: teksnya })
              break
case 'pricegtfo':
              gopeynya = 'https://i.ibb.co/kynNYTh/ganteng.jpg'
...
*ID Guild :* -
*Minat Join? Chat* wa.me/6287871956719
#WAVEFOREVER!`
              dha.sendMessage(from, await getBuffer(gopeynya), image, {quoted: ftoko, caption: teksnya })
              break
